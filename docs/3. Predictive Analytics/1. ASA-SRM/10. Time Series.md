...
!!! Tip
    ...
    A **typical value** for $w$ is within the range $(0.75, 0.95)$. Similarly, there is NO smoothing when $w=0$.
...
!!! Note
    ...
    The above metrics can be used to **identify trend** patterns in the data.
