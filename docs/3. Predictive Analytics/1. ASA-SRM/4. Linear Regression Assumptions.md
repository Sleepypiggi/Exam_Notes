...
<!-- Obtained from Penn State University -->
![HIGH_LEVERAGE](Assets/4.%20Linear%20Regression%20Assumptions.md/HIGH_LEVERAGE.png){.center}
...
<!-- Obtained from Penn State University -->
![HIGH_OUTLIER](Assets/4.%20Linear%20Regression%20Assumptions.md/HIGH_OUTLIER.png){.center}
...
<!-- Obtained from Penn State University -->
![HIGH_INFLUENCE](Assets/4.%20Linear%20Regression%20Assumptions.md/HIGH_INFLUENCE.png){.center}

!!! Tip

    All the previous plots in the previous section in a similar format for Leverage and Outliers are plots which show an observation which is ONLY an Outlier or ONLY has high leverage. The above plot for influence is an observation with BOTH high leverage and is an outlier.
