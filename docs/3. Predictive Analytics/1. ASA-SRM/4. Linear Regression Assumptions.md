...
The key difference when compared to PCA is that PLS finds new variables with the **inherent goal of explaining the dependent variable**. Consequently, cross validation can be used to determine the optimal number of directions.
