...
There are two issues with the Validation approach:

1. **No fixed method of splitting** the data - Prone to variation
2. Only a **subset of observations** are used - Prone to poorer fits

This above can be overcome by using **Cross Validation** instead:
