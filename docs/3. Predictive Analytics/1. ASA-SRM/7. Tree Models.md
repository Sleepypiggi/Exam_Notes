...
!!! Note
    ...
    This is why this method is known as **Cost Complexity Pruning**.
...
* **Learning Rate** ($\lambda$) - How much each tree contributes to the overall prediction ($\lambda \lt 1$)
...
!!! Note
    ...
    It is especially important for the first few trees as the **numerical prediction tends to be higher**.
