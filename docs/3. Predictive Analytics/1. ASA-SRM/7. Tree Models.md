...
!!! Tip
    ...
    In fact, for a sufficiently large number of trees, the OOB provides an reasonably good **estimate of the LOOCV error** with the added advantage of being computationally more efficient:
