...
\begin{aligned}
    ...
    \\
    \therefore E(Y \mid X_{1} = x_{1, i}, ... X_{p} = x_{p,i})
    &= \beta_{0} + \beta_{1} \cdot x_{1, i} + \beta_{2} \cdot x_{2, i} + \dots
    \\ 
    \therefore y_{i}
    &= \beta_{0} + \beta_{1} \cdot x_{1, i} + \beta_{2} \cdot x_{2, i} + \dots + \varepsilon_{i}
\end{aligned}
$$
