...
!!! Tip
    ...
    There are questions which may ask for the impact of a variable on the response given some or all other variables are held constant. As shown above, the impact of a variable **changes in the presence of an interaction term** - which is the motivation of these questions:

    * Impact of **target variable**
    * Impact of **interaction** between target variable and other variable
    * If the other variable is not held constant, consider **extreme scenarios** for the otger variable to know the definitive impact
