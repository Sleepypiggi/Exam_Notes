...
!!! Note
    ...
    In a similar light, for MLR, we consider the **Partial Correlation** between the dependent and independent variable, which holds the effect of all other variables constant.
...
!!! Tip
    ...
    It is NOT recommended to memorize the above formula, it can be derived from first principles using the ANOVA table.
