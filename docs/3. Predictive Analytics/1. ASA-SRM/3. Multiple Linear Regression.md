...
* **Ridge**: Shrinks all coefficients by the **same proportion**
* **LASSO**: Shrinks all coefficients by a **constant amount**; but if **smaller than the constant**, then the coefficient is set to 0 (Dropped)
