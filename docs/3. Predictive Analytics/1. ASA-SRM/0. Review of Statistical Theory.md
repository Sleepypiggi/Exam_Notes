...
However, the units of the variance are squared, which makes it hard to hard to interpret.

Thus, the **Standard Deviation** which is the square root of the variance is also considered:

!!! Warning
    
    The Variance is not strictly worse than the Standard Deviation. It has the following key properties that still make it desirable:
...
The last common measure is the Interquartile Range. It is the difference between the 75th and 25th Percentiles:
...
!!! Info
    ...
    The above plot is known as a Box-Plot.
