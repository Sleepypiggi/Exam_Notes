...
Prediction is largely related to the **Flexibility** of the model; how well the model tracks the sample. As will be shown later, a moderate amount of flexibility is ideal with regards to prediction.
...
The above can be understand as the combination of:
