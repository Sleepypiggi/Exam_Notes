...
!!! Tip
    ...
    The line in the middle linearly connecting the two endpoints only represents has an AUC of 0.5. This occurs when the model makes positive and negative predictions almost equally. This is considered to be a poor classifier as any increase in sensitivity results in a same decrease in specificity.
