...
The SIGN of the deviance residuals follow the sign of the **Raw Residual**. Thus, the sign can be used for 

!!! Warning

    Deviance residuals are DIFFERENT from the raw residuals used in MLR. Do NOT confuse the two!
