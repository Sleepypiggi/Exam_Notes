...
Another similar concept is **Weights**. Each observation is assigned a Weight **based on one or more other variables** - the model will fit better fit to observations with higher weight; weights adjust the influence of each observation.
