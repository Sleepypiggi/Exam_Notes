...
!!! Note
    ...
    However, the converse is true as well - clustering might result in different groupings based on patterns in the data that are not captured by the pre-defined groupings.
