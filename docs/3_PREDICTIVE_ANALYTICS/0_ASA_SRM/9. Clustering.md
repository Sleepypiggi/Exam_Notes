...
* **Cluster Groups** as a categorical variable (More common)
...
The choice of whether or not to do so boils down to the choice of using a Numeric or Categorical variable in the model, which has more general considerations.
