...
!!! Warning
    ...
    The above represents the **probability of being in state $j$** at time $t$. If more generally asked for the **probability of transitioning** to state $j$, the last term can be dropped:
