...
Adverse Selection will result in **actual experience being far worse** than what was assumed, which would lead to the policies being under-reserved, which could threaten the solvency of the insurer.