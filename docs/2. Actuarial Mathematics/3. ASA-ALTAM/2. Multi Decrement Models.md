...
Questions of this nature tend to involve **fractional times** (though not always). Similar to before, additional assumptions are required (Constant Force, UDD) in order to determine the probabilities. These add **another layer of complexity** to the conversion.
