...
The first method involves purchasing the required options from a third party.
...
the insurer can **completely hedge the risk** by investing in a **replicating portfolio** of stocks and zero-coupon bonds. Whenever the option is exercised, the insurer can **liquidate the replicating portfolio to completely cover** the payoff of the option.
