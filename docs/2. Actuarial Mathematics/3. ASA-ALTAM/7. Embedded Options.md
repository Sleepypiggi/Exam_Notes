...
Alternatively, the insurer can create a **replicating portfolio** of stocks and zero-coupon bonds that will match the payoff of the required option(s). If the guarantee would be exercised, the insurer can **liquidate** the replicating portfolio to cover the cost.
