...
Since the policyholder's account is purely notional, the **typical profit testing** approach can be taken. The key is to remember that:

* The insurer holds **reserves equal to the account value**
* The benefits paid out are a function of the account value
