...
!!! Tip
    ...
    The difficulty is usually calcualating the **observed time spent**. This is especially true when there are multiple people **transitioning back and forth between states**:
