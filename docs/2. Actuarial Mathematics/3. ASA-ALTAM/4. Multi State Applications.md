...
| **Level** payments for all units | Payments **step up** when moving to new unit | Pay **per use at market rate** |
...
If the damage is **severe**, the final long term damage may not be known till an initial period of treatment is completed. The time after the treatment is completed is known as the time of **Maximum Medical Improvement** (MMI).

Thus, the settlement will only be finalized at the time of MMI; **interim benefits** will be payable till that time.
