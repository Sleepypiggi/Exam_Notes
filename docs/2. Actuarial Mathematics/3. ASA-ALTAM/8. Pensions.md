...
\begin{aligned}
    {}_{n}V
    &= n \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
    {}_{n+1}V
    &= (n+1) \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x-1} {}_{65-x-1}p_{x+1} \\
    \\
    {}_{n+1}V \cdot vp_{x} 
    &= (n+1) \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x+1} p_{x} \\
    &= (n+1) \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
    &= \frac{n}{n} \cdot (n+1) \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
    &= \frac{n+1}{n} \cdot n \alpha S_{65} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
...
\begin{aligned}
    {}_{n}V
    &= n \alpha S_{n} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
    {}_{n+1}V
    &= (n+1) \alpha S_{n+1} \cdot \ddot{a}_{65} \cdot v^{65-x-1} {}_{65-x-1}p_{x+1} \\
    \\
    {}_{n+1}V \cdot vp_{x} 
    &= (n+1) \alpha S_{n+1} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x+1} p_{x} \\
    &= (n+1) \alpha S_{n+1} \cdot \ddot{a}_{65} \cdot v^{65-x} {}_{65-x}p_{x} \\
