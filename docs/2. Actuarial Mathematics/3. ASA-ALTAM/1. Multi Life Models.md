...
!!! Warning
    ...
    \begin{aligned}
        ...
        &= \frac{1}{\delta^2} \cdot \text{Cov} \left(v^{T_{x:y}}, v^{T_{\overline{x:y}}} \right) \\
        &= \frac{1}{\delta^2} \cdot \left(A_{x} - A_{x:y} \right) \left(A_{y} - A_{x:y} \right)
    \end{aligned}
    $$
    ...
    \begin{aligned}
        ...
        &= \frac{1}{\delta^2} \cdot \left(A_{x} - A_{x:y} \right) \left(A_{y} - A_{x:y} \right) \\
        &= \frac{1}{\delta^2} \cdot \left(A_{x} - A_{x:y} + 1 - 1 \right) \left(A_{y} - A_{x:y} + 1 - 1 \right) \\
        &= \frac{1}{\delta^2} \cdot \left[-1 + A_{x} + 1 - A_{x:y} \right] \left[-1 + A_{y} + 1 - A_{x:y} \right] \\
        &= \frac{1}{\delta^2} \cdot \left[- (1 - A_{x}) + (1 - A_{x:y}) \right] \left[- (1 - A_{y}) + (1 - A_{x:y}) \right] \\
        &= \frac{1}{\delta^2} \cdot (-1)(-1) \left[(1 - A_{x}) - (1 - A_{x:y}) \right] \left[(1 - A_{y}) - (1 - A_{x:y}) \right] \\
        &= \frac{\left[(1 - A_{x}) - (1 - A_{x:y}) \right]}{\delta} \frac{\left[(1 - A_{y}) - (1 - A_{x:y}) \right]}{\delta} \\
        &= \left(\frac{1 - A_{x}}{\delta} - \frac{1 - A_{x:y}}{\delta} \right)
            - \left(\frac{1 - A_{y}}{\delta} - \frac{1 - A_{x:y}}{\delta} \right) \\
...
!!! Tip
    ...
    The same logic can be applied to be probabilities as well:
